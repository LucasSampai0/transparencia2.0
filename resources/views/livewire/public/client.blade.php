    ...
    <div class="flex flex-row">
        <div class="p-4 grow bg-blue-200">
            ...
            <div class="grid grid-cols-4 gap-4 mb-4">
                <div class="group flex flex-col items-center justify-between rounded bg-gray-50 dark:bg-gray-800 rounded-lg pt-8 gap-12 overflow-hidden hover:">
                    ...
                    <button class="w-full px-4 py-1 bg-[#93DD00] relative translate-y-full group-hover:translate-y-0 transition">
                        <a class="text-xl text-white flex justify-center" href="">
                            Ver mais
                        </a>
                    </button>
                </div>
